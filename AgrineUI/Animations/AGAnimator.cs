...
namespace AgrineUI.Animations
{
    ...
    public class AGAnimator : Component, IExtenderProvider
    {
        ...
        public AGAnimation DefaultAnimation { get; set; }
        ...
        public AGAnimator(IContainer container)
        {
            container.Add(this);
            Init();
        }
        ...
        protected virtual void Init()
        {
            ...
            DefaultAnimation = new AGAnimation();
        ...
        private void InitDefaultAnimation(AnimationType animationType)
        {
            switch (animationType)
            {
                ...
                case AnimationType.Rotate: DefaultAnimation = AGAnimation.Rotate; break;
                case AnimationType.HorizSlide: DefaultAnimation = AGAnimation.HorizSlide; break;
                case AnimationType.VertSlide: DefaultAnimation = AGAnimation.VertSlide; break;
                case AnimationType.Scale: DefaultAnimation = AGAnimation.Scale; break;
                case AnimationType.ScaleAndRotate: DefaultAnimation = AGAnimation.ScaleAndRotate; break;
                case AnimationType.HorizSlideAndRotate: DefaultAnimation = AGAnimation.HorizSlideAndRotate; break;
                case AnimationType.ScaleAndHorizSlide: DefaultAnimation = AGAnimation.ScaleAndHorizSlide; break;
                case AnimationType.Transparent: DefaultAnimation = AGAnimation.Transparent; break;
                case AnimationType.Leaf: DefaultAnimation = AGAnimation.Leaf; break;
                case AnimationType.Mosaic: DefaultAnimation = AGAnimation.Mosaic; break;
                case AnimationType.Particles: DefaultAnimation = AGAnimation.Particles; break;
                case AnimationType.VertBlind: DefaultAnimation = AGAnimation.VertBlind; break;
                case AnimationType.HorizBlind: DefaultAnimation = AGAnimation.HorizBlind; break;
            }
        }
        ...
        public void Show(Control control, bool parallel = false, AGAnimation animation = null)
        {
        ...
        /// <param name="parallel">Allows to animate it same time as other animations</param>
        /// <param name="animation">Personal animation</param>
        public void ShowSync(Control control, bool parallel = false, AGAnimation animation = null)
        {
        ...
        /// <param name="parallel">Allows to animate it same time as other animations</param>
        /// <param name="animation">Personal animation</param>
        public void Hide(Control control, bool parallel = false, AGAnimation animation = null)
        {
        ...
        /// <param name="parallel">Allows to animate it same time as other animations</param>
        /// <param name="animation">Personal animation</param>
        public void HideSync(Control control, bool parallel = false, AGAnimation animation = null)
        {
        ...
        public void BeginUpdate(Control control, bool parallel = false, AGAnimation animation = null, Rectangle clipRectangle = default(Rectangle))
        {
        ...
        /// <param name="parallel">Allows to animate it same time as other animations</param>
        /// <param name="animation">Personal animation</param> 
        public void AddToQueue(Control control, AnimateMode mode, bool parallel = true, AGAnimation animation = null, Rectangle clipRectangle = default(Rectangle))
        {
            if (animation == null)
